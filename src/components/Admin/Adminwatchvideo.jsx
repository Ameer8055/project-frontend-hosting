...
const AdminWatchVideo = () => {
  ...
  return (
    <div>
      ...
      <Link to={`/admin/uploader/${video.uploader}/videos`}><p className='text-white text-end me-3 mt-4'>GO BACK</p></Link>
      </div>
      ...
      <p className="text-yellow-500 mt-2">{video.price === "free" ? "Free" : "Paid"}</p>
      <CommentForUploader/>
    </div>
    </div>
  );
